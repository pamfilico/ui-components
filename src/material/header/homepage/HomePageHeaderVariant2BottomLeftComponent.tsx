...
export interface HomePageHeaderVariant2BottomLeftComponentProps {
  session: {
    user?: {
      name?: string | null;
      email?: string | null;
...
export const HomePageHeaderVariant2BottomLeftComponent: React.FC<
  HomePageHeaderVariant2BottomLeftComponentProps
> = ({
  session,
  onSignIn,
  onSignOut,
