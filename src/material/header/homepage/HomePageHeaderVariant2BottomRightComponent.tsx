...
export interface HomePageHeaderVariant2BottomRightComponentProps {
  session: {
    user?: {
      name?: string | null;
      email?: string | null;
...
export const HomePageHeaderVariant2BottomRightComponent: React.FC<HomePageHeaderVariant2BottomRightComponentProps> = ({
  session,
  onSignIn,
  onSignOut,
  onAppsClick,
