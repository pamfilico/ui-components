...
export interface HomePageHeaderVariant2TopLeftComponentProps {
  session: {
    user?: {
      name?: string | null;
      email?: string | null;
...
export const HomePageHeaderVariant2TopLeftComponent: React.FC<HomePageHeaderVariant2TopLeftComponentProps> = ({
  session,
  onSignIn,
  onSignOut,
  onAppsClick,
