...
/**
 * HomePageHeaderVariant2TopLeftComponent - Mobile header with top-left navigation
 */
const meta = {
  title: "Material/Header/Homepage/HomePageHeaderVariant2TopLeftComponent",
  component: HomePageHeaderVariant2TopLeftComponent,
  parameters: {
    layout: "fullscreen",
  },
  tags: ["autodocs"],
...
} satisfies Meta<typeof HomePageHeaderVariant2TopLeftComponent>;
...
export const LoggedOut: Story = {
  ...
  render: (args) => (
    <Box>
      <HomePageHeaderVariant2TopLeftComponent {...args} />
      <Box sx={{ height: "200vh", p: 4 }}>
        <Typography variant="h5" sx={{ mt: 10 }}>
          Mobile header - Logged out (Top-Left)
        </Typography>
        <Typography variant="body1" sx={{ mt: 2 }}>
          Auth button (top-right), FAB navigation (top-left vertical)
        </Typography>
      </Box>
    </Box>
  ),
...
export const LoggedIn: Story = {
  ...
  render: (args) => (
    <Box>
      ...
      <Box sx={{ height: "200vh", p: 4 }}>
        <Typography variant="h5" sx={{ mt: 10 }}>
          Mobile header - Logged in (Top-Left)
        </Typography>
        <Typography variant="body1" sx={{ mt: 2 }}>
