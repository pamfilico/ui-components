...
const meta = {
  title: "Material/Home/DynamicUsagePricingComponentVariant2",
  component: DynamicUsagePricingComponentVariant2,
  parameters: {
    layout: "fullscreen",
  },
  tags: ["autodocs"],
} satisfies Meta<typeof DynamicUsagePricingComponentVariant2>;
